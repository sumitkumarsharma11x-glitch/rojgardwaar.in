# -*- coding: utf-8 -*-
"""Generate data/science/chemistry/chapter-01/questions.json (C01 — पदार्थ एवं उसकी अवस्थाएँ / Matter & Its States).
Builds exactly 200 bilingual questions with ids chem1_q101..chem1_q300 from c01_part1 + c01_part2.
"""
import json
import os
import sys
...
from c01_part1 import PART1
from c01_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "chemistry", "chapter-01", "questions.json",
    )
