# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-03/questions.json (P03 — Force & Laws of Motion).
Builds exactly 150 bilingual questions with ids phy3_q101..phy3_q250 from p03_part1 + p03_part2.
"""
import json
import os
import sys
...
from p03_part1 import PART1
from p03_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-03", "questions.json",
    )
