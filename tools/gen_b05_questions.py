# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-06/questions.json (B05 — Animal Life & Body Functions).
Builds exactly 150 bilingual questions with ids ch6_q601..ch6_q750 from b05_part1 + part2.
"""
import json
import os
import sys
...
from b05_part1 import PART1
from b05_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-06", "questions.json",
    )
