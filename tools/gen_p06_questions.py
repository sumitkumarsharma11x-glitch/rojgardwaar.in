# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-06/questions.json (P06 — Heat & Temperature).
Builds exactly 150 bilingual questions with ids phy6_q101..phy6_q250 from p06_part1 + p06_part2.
"""
import json
import os
import sys
...
from p06_part1 import PART1
from p06_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-06", "questions.json",
    )
