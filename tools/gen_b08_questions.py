# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-09/questions.json (B08 — Transportation & Circulation).
Builds exactly 150 bilingual questions with ids ch9_q901..ch9_q1050 from b08_part1 + part2 + part3.
"""
import json
import os
import sys
...
from b08_part1 import PART1
from b08_part2 import PART2
from b08_part3 import PART3
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-09", "questions.json",
    )
