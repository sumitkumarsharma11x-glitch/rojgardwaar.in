# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-05/questions.json (B04 — Plant Life & Plant Functions).
Builds exactly 150 bilingual questions with ids ch5_q501..ch5_q650 from b04_part1 + part2 + part3.
"""
import json
import os
import sys
...
from b04_part1 import PART1
from b04_part2 import PART2
from b04_part3 import PART3
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-05", "questions.json",
    )
