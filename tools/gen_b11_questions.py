# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-11/questions.json (B11 — Health, Disease & Microorganisms).
Builds exactly 150 bilingual questions with ids ch10_q1001..ch10_q1150 from b11_part1 + part2.
"""
import json
import os
import sys
...
from b11_part1 import PART1
from b11_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-11", "questions.json",
    )
