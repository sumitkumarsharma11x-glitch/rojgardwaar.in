# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-05/questions.json (P05 — Work, Energy & Power).
Builds exactly 150 bilingual questions with ids phy5_q101..phy5_q250 from p05_part1 + p05_part2.
"""
import json
import os
import sys
...
from p05_part1 import PART1
from p05_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-05", "questions.json",
    )
