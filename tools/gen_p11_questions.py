# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-11/questions.json (P11 — Effects of Electric Current & Energy).
Builds exactly 200 bilingual questions with ids phy11_q101..phy11_q300 from p11_part1 + p11_part2.
"""
import json
import os
import sys
...
from p11_part1 import PART1
from p11_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-11", "questions.json",
    )
