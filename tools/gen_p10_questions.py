# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-10/questions.json (P10 — Magnetism & Electromagnetic Effects).
Builds exactly 200 bilingual questions with ids phy10_q101..phy10_q300 from p10_part1 + p10_part2.
"""
import json
import os
import sys
...
from p10_part1 import PART1
from p10_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-10", "questions.json",
    )
