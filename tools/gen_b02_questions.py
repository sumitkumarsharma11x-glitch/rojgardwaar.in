# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-03/questions.json (B02 — Tissues & Body Structure).
Builds exactly 150 bilingual questions with ids ch3_q301..ch3_q450 from b02_part1 + b02_part2.
"""
import json
import os
import sys
...
from b02_part1 import PART1
from b02_part2 import PART2
...
def main():
    ...
    # order per blueprint: skeletal -> plant -> epithelial/connective -> joints -> muscular/nervous -> organization
    ...
    for i, (topic, diff, qhi, qen, ohi, oen, correct, ehi, een) in enumerate(rows):
        ...
        assert all(isinstance(x, str) and x.strip() for x in ohi + oen), "empty option"
        questions.append({
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-03", "questions.json",
    )
