# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-12/questions.json (B12 — Environment, Ecosystems & Natural Resources).
Builds exactly 150 bilingual questions with ids ch12_q1201..ch12_q1350 from b12_part1 + part2.
"""
import json
import os
import sys
...
from p02_part1 import PART1
from p02_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-02", "questions.json",
    )
