# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-04/questions.json (P04 — Gravitation, Weight & Pressure).
Builds exactly 150 bilingual questions with ids phy4_q101..phy4_q250 from p04_part1 + p04_part2.
"""
import json
import os
import sys
...
from p04_part1 import PART1
from p04_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-04", "questions.json",
    )
