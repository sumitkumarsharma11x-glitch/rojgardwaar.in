# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-10/questions.json (B10 — Growth, Development & Adolescence).
Builds exactly 150 bilingual questions with ids ch10_q1001..ch10_q1150 from b10_part1 + part2.
"""
import json
import os
import sys
...
from b10_part1 import PART1
from b10_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-10", "questions.json",
    )
