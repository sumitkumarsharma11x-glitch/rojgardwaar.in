# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-12/questions.json (P12 — Space, Earth & Basic Physical Phenomena).
Builds exactly 200 bilingual questions with ids phy12_q101..phy12_q300 from p12_part1 + p12_part2.
"""
import json
import os
import sys
...
from p12_part1 import PART1
from p12_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-12", "questions.json",
    )
