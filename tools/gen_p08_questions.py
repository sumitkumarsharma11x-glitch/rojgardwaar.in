# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-08/questions.json (P08 — Light, Reflection & Refraction).
Builds exactly 200 bilingual questions with ids phy8_q101..phy8_q300 from p08_part1 + p08_part2.
"""
import json
import os
import sys
...
from p08_part1 import PART1
from p08_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-08", "questions.json",
    )
