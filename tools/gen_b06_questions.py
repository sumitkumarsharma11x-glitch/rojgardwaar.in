# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-07/questions.json (B06 — Nutrition & Digestion).
Builds exactly 150 bilingual questions with ids ch7_q701..ch7_q850 from b06_part1 + part2.
"""
import json
import os
import sys
...
from b06_part1 import PART1
from b06_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-07", "questions.json",
    )
