# -*- coding: utf-8 -*-
"""Generate data/science/physics/chapter-09/questions.json (P09 — Electricity & Electric Circuits).
Builds exactly 200 bilingual questions with ids phy9_q101..phy9_q300 from p09_part1 + p09_part2.
"""
import json
import os
import sys
...
from p09_part1 import PART1
from p09_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "physics", "chapter-09", "questions.json",
    )
