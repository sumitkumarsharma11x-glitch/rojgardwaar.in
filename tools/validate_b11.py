...
against all TEN locked banks (B01 ch-01, B09 ch-02, B02 ch-03, B03 ch-04, B04 ch-05,
...
EXPECTED_TOPICS = {
    "harmful-microbes": 30,
    "microbial-world": 25,
    "useful-microorganisms": 25,
    "disease-dynamics": 25,
    "immunity-prevention": 25,
    "health-hygiene": 20,
}
...
def main():
    ...
    b10 = load(os.path.join(ROOT, "data/science/biology/chapter-11/questions.json"))
    banks = {
    ...
    if ids != [f"ch11_q{n}" for n in range(1101, 1251)]:
        errors.append("id sequence not exactly ch11_q1101..ch11_q1250")
    ...
    check_cross("B11-internal", b10, b10, errors, warnings, internal=True)
