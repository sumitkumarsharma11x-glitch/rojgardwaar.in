# -*- coding: utf-8 -*-
"""Validate C01 (chemistry chapter-01) question bank: structure + duplicate/stem-similarity
against all TWELVE locked biology banks + P01-P12 physics (24 frozen chapters) and within
...
def main():
    ...
    banks = {
        ...
        "P01": load(os.path.join(ROOT, "data/science/physics/chapter-01/questions.json")),
    ...
    if ids != [f"chem1_q{n}" for n in range(101, 301)]:
        errors.append("id sequence not exactly chem1_q101..chem1_q300")
    ...
    check_cross("C01-internal", c01, c01, errors, warnings, internal=True)
