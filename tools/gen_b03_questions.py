# -*- coding: utf-8 -*-
"""Generate data/science/biology/chapter-04/questions.json (B03 — Diversity & Classification).
Builds exactly 150 bilingual questions with ids ch4_q401..ch4_q550 from b03_part1 + b03_part2.
"""
import json
import os
import sys
...
from b03_part1 import PART1
from b03_part2 import PART2
...
def main():
    ...
    out_path = os.path.join(
        ...
        "data", "science", "biology", "chapter-04", "questions.json",
    )
